...
Genug der Vorrede, nun zur Sache: Die Förderung beträgt deutschlandweit bei den aktuell gültigen Sätzen (seit Herbst ~2020) maximal \SI{861}{\euro} (eigenständiger Student), \SI{592}{\euro} (bei den Eltern wohnend). Diese Förderung setzt sich zusammen aus dem Grundbetrag inkl.\ Wohnzuschlag (\SI{752}{\euro} bzw.\ \SI{483}{\euro}) und dem optionalen KV-/PV-Zuschlag (\SI{109}{\euro}) für Studierende, die selber kranken- bzw.\ pflegeversichert sind.
...
Habt ihr größere Ersparnisse, so wird der über einen gewissen Freibetrag (für ledige, kinderlose Auszubildende ab WiSe 20/21 dann \SI{8200}{\euro}) hinausgehende Anteil ebenfalls zu eurem Einkommen hinzugerechnet (\num{1/12} davon pro Monat).
...
0cm \columnwidth
AB Wintersemester~2020/2021 können sich Studenten an erhöhten Bedarfssätzen und Freibeträgen des BAföG erfreuen.
Im Vergleich zu vorher wurden die Bedarfssätze und der Wohngeldzuschlag um zwei Prozent angehoben.
