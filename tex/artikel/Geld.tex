...
Genug der Vorrede, nun zur Sache: Die Förderung beträgt deutschlandweit bei den aktuell gültigen Sätzen (seit August~2019) maximal \SI{853}{\euro} (eigenständig wohnende Studenten) bzw.\ \SI{583}{\euro} (bei den Eltern wohnende Studenten).
Diese Förderung setzt sich zusammen aus dem Grundbetrag inkl.\ Wohnzuschlag (\SI{744}{\euro} bzw.\ \SI{474}{\euro}) und dem optionalen KV-/PV-Zuschlag (\SI{109}{\euro}) für Studierende, die selber kranken- bzw.\ pflegeversichert sind.
